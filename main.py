...
async def on_ready():
    ...
    bot.loop.create_task(realtime_check_new_episodes())
...
async def realtime_check_new_episodes():
    while True:
        ...
        await asyncio.sleep(60)  # Tunggu 1 menit sebelum melakukan pengecekan lagi
